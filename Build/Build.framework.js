...
var ASM_CONSTS = {
  2898004: () => { Module['emscripten_get_now_backup'] = performance.now; },  
 2898059: ($0) => { performance.now = function() { return $0; }; },  
 2898107: ($0) => { performance.now = function() { return $0; }; },  
 2898155: () => { performance.now = Module['emscripten_get_now_backup']; }
};
