...
var ASM_CONSTS = {
  2896020: () => { Module['emscripten_get_now_backup'] = performance.now; },  
 2896075: ($0) => { performance.now = function() { return $0; }; },  
 2896123: ($0) => { performance.now = function() { return $0; }; },  
 2896171: () => { performance.now = Module['emscripten_get_now_backup']; }
};
