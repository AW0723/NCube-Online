...
var ASM_CONSTS = {
  2898052: () => { Module['emscripten_get_now_backup'] = performance.now; },  
 2898107: ($0) => { performance.now = function() { return $0; }; },  
 2898155: ($0) => { performance.now = function() { return $0; }; },  
 2898203: () => { performance.now = Module['emscripten_get_now_backup']; }
};
